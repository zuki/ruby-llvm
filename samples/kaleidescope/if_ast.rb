...
class IfExprAST < ExprAST
  ...
  def code(the_module, builder, the_fpm )
    return nil unless condition_value = @cond.code(the_module, builder, the_fpm)
    ...
    return nil unless then_value = @then.code(the_module, builder, the_fpm)
...
#needed??    theFunction->getBasicBlockList().push_back(else_block)
    ...
    return nil unless else_value = @else.code(the_module, builder, the_fpm)
