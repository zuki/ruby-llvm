...
class ForExprAST < ExprAST
  ...
  def code(the_module , builder, the_fpm)
    ...
    return nil unless startVal = @start.code(the_module, builder, the_fpm)
    ...
    return nil unless loop_val = @body.code(the_module, builder, the_fpm)

    # Emit the step value.
    stepVal = @step.code(the_module, builder, the_fpm)
    ...
    endCond = @end.code(the_module, builder, the_fpm)
